      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="text-center lg:text-left lg:w-1/2 space-y-6">
            <div className="p-0 rounded-lg inline-block mb-8">
              <Image
            ...
            <h1 className="text-primary text-4xl md:text-5xl font-bold mb-4">Answer with confidence.</h1>
            <h2 className="text-2xl md:text-3xl font-medium text-primary-light mb-6">
              VoiGuard tells you who's calling, when, and why.
            </h2>
            <p className="text-gray-dark text-lg mb-8 max-w-xl mx-auto lg:mx-0">
          ...
          <div className="lg:w-1/2 relative">
            <div className="relative mx-auto w-[280px] md:w-[320px]">
              <Image
                src="/images/Push-notification-voiguard.png"
              ...
              <div className="absolute -top-4 -left-4 bg-white/10 backdrop-blur-sm p-3 rounded-lg border border-white/20">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-primary text-sm font-medium">Verified Call</span>
                </div>
              </div>
            </div>
          </div>
